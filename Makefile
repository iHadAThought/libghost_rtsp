...
all: libmedia_core.a libghost_ffmpeg_rx.a libghost_rtsp.a
...
libghost_rtsp.a: src/modules/rtsp/ghost_rtsp.c include/ghost_rtsp.h libghost_ffmpeg_rx.a libmedia_core.a
	$(CC) $(CFLAGS) -c -o ghost_rtsp.o src/modules/rtsp/ghost_rtsp.c && $(AR) rcs $@ ghost_rtsp.o && rm -f ghost_rtsp.o

install: all
	install -d $(DESTDIR)$(PREFIX)/include $(DESTDIR)$(PREFIX)/lib
	install -m 644 include/*.h $(DESTDIR)$(PREFIX)/include/
	install -m 644 libmedia_core.a libghost_ffmpeg_rx.a libghost_rtsp.a $(DESTDIR)$(PREFIX)/lib/
